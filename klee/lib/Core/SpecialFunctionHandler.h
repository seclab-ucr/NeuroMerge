...
namespace klee {
  ...
  public:
    ...
    // void handleOpenMerge(ExecutionState &state, KInstruction *target, std::vector<ref<Expr>> &arguments, const std::string &unique_id);
    /* Handlers */
...
#undef HANDLER
    ...
    // void handleOpenMerge(ExecutionState &state, KInstruction *target, std::vector<ref<Expr>> &arguments, std::string &unique_id);
  };
} // End klee namespace
